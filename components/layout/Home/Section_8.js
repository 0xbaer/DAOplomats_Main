    ...
    return (
        <div className="w-full px-[240px] py-[150px] flex gap-[100px] justify-center relative">
            ...
            <div className="flex flex-col items-center justify-center  z-10 w-full text-[#242424]">
                <h1 className={"text-[120px] text-white text-center " + Philosopher.className}>
                    Let's work <span className="text-[#DFE225]">Together</span>
                </h1>
                <h4 className="text-[20px] text-white font-light">Just drop us a message here!</h4>
                <div className="grid grid-cols-2 w-[70%] gap-[20px] mt-24 mb-5">
                    <input type="name" class="bg-[#333F3D] p-2 border border-[#FCFBEB30] text-gray-100 text-[16px]  focus:ring-1 focus:outline-none block w-full p-2.5 " placeholder="Your Name" required/>
                    <input type="email" class="bg-[#333F3D] p-2 border border-[#FCFBEB30] text-gray-100 text-[16px]  focus:ring-1 focus:outline-none block w-full p-2.5 " placeholder="Your Mail" required/>
                </div>
                <input type="name" class="bg-[#333F3D] p-2 border border-[#FCFBEB30] text-gray-100 text-[16px]  focus:ring-1 focus:outline-none block w-[70%] p-2.5 mb-5 " placeholder="Main service you are interested" required/>
                <textarea
                    id='message'
