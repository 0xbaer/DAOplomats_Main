  ...
  return (
    <div className="w-full px-[10px] md:px-[80px] lg:px-[240px] py-[150px] flex gap-[100px] justify-center relative">
      ...
      <div className="flex flex-col items-center justify-center z-10 w-full text-[#242424]">
        <h1
          className={
            "text-[50px] sm:text-[80px] lg:text-[120px] text-white text-center " +
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-10/12 -translate-x-3 md:-translate-x-0 md:w-[70%] gap-[20px] mt-24 mb-5">
          <input
            type="name"
        ...
        <input
          type="name"
          className="bg-[#333F3D] border border-[#FCFBEB30] text-gray-100 text-[16px]  focus:ring-1 focus:outline-none block w-10/12 -translate-x-3 md:-translate-x-0 md:w-[70%] p-2.5 mb-5 "
          placeholder="Main service you are interested"
          required
        />
        <textarea
          id="message"
          className="block bg-[#333F3D] min-h-[200px] p-2.5 w-10/12 -translate-x-3 md:-translate-x-0 md:w-[70%] text-[16px] text-gray-100 border border-[#FCFBEB30] focus:ring-1 focus:outline-none mb-5"
