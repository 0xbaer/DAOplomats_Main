...
export default function Section_3() {
    ...
    return (
        <div className="w-full flex flex-col gap-[96px] py-[103px] px-[60px] relative bg-[#333F3D]">
            <div className="flex items-center justify-between w-full h-[331px] relative">
                ...
                <div className="flex items-center justify-center w-[408px] text-white text-center">
                    Donec luctus orci eros, eget mollis turpis gravida sed.
                    Vestibulum id feugiat tellus.Donec luctus orci eros, eget mollis
                    turpis gravida sed. Vestibulum id feugiat tellus.
                </div>
            </div>
            ...
            <div className="w-full px-[240px] py-[150px] flex gap-[100px] justify-center relative">
                ...
                <div className="flex flex-col gap-[80px] z-10 w-full ">
                    <h1 className={"text-[32px] w-[918px] text-white " + Helvetica.className}>
                        Donec luctus orci eros, eget mollis turpis gravida sed.
                        Vestibulum id feugiat tellus. Donec luctus orci eros,
                        eget mollis turpis gravida sed. Vestibulum id feugiat tellus.
                    </h1>
                        ...
                        <div className={"flex flex-col"} >
                            ...
                            <div className="flex flex-row gap-[50px]">
                                <div className="flex flex-col gap-[40px] w-[271px]">
                                    <div>
                                        <h1 className={"text-[#DFE225] text-[18px] " +Philosopher.className}> Objective decision making </h1>
                                        <p className="text-[#FCFBEB] text-[16px]">
                                            We design and implement decision making 
                                            frameworks which enable us to perform 
                                            qualitative and quantative analysis in 
                                            order to arrive at conclusions.
                                        </p>
                                    </div>
                                    <div>
                                        <h1 className={"text-[#DFE225] text-[18px] " +Philosopher.className}>Decentralisation </h1>
                                        <p className="text-[#FCFBEB] text-[16px]">
                                        We believe in a highly distributed power 
                                        structures and strive to push decision making power to the edges
                                        </p>
                                    </div>
                                </div>
                                <div className="flex flex-col gap-[40px] w-[271px]">
